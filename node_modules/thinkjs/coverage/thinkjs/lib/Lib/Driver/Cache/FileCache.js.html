...
<html lang="en">
<head>
    <title>Code coverage report for thinkjs/lib/Lib/Driver/Cache/FileCache.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">thinkjs/lib/Lib/Driver/Cache/FileCache.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">thinkjs/lib/Lib/Driver/Cache/</a> &#187; FileCache.js</div>
</div>
<div class="body">
...
&nbsp;
    ...
    gc: function(now, path){
      ...
      files.forEach(function(item){
        ...
        }else <span class="missing-if-branch" title="else path not taken" >E</span>if (stat.isFile()) {
